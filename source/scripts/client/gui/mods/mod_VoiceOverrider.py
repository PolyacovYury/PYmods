...
class ConfigInterface(SimpleConfigInterface):
    ...
    def __init__(self):
        ...
        self.voice_modes = [
            ...
            VoiceMode('valkyrie_male', 'valkyrie2'),
            VoiceMode('valkyrie_female', 'valkyrie1'),
            VoiceMode('sabaton', 'sabaton'),
            VoiceMode('buffon', 'buffon'),
            VoiceMode('offspring', 'offspring'),
            VoiceMode('celebrity2021_ru', 'celebrity2021_ru'),
            VoiceMode('celebrity2021_en', 'celebrity2021_en'),
            VoiceMode('racer_ru', 'racer_ru'),
            VoiceMode('racer_en', 'racer_en'),
            VoiceMode('20_LeBwa', 'ru1_Lebwa'),
            VoiceMode('20_Yusha', 'ru2_Yusha'),
            VoiceMode('20_Amway921', 'ru3_Amway921'),
            VoiceMode('20_KorbenDallas', 'ru4_KorbenDallas'),
            VoiceMode('20_Mailand', 'eu1_Mailand'),
            VoiceMode('20_Skill4ltu', 'eu2_Skill4ltu'),
            VoiceMode('20_Dezgamez', 'eu3_Dezgamez'),
            VoiceMode('20_AwesomeEpicGuys', 'eu4_AwesomeEpicGuys'),
            VoiceMode('21_Yusha', 'bb21_ru1_Yusha'),
            VoiceMode('21_Vspishka', 'bb21_ru1_Vspishka'),
            VoiceMode('21_Amway921', 'bb21_ru2_Amway921'),
            VoiceMode('21_KorbenDallas', 'bb21_ru2_Korbendailas'),
            VoiceMode('21_LeBwa', 'bb21_ru3_Lebwa'),
            VoiceMode('21_Inspirer', 'bb21_ru3_Inspirer'),
            VoiceMode('21_Evil_Granny', 'bb21_ru4_Evilgranny'),
            VoiceMode('21_Near_You', 'bb21_ru4_Nearyou'),
            VoiceMode('21_Circon', 'bb21_eu1_Circon'),
            VoiceMode('21_Dakillzor', 'bb21_eu2_Dakillzor'),
            VoiceMode('21_Newmulti2k', 'bb21_eu3_Newmulti2k'),
            VoiceMode('21_Orzanel', 'bb21_eu4_Orzanel'),
            VoiceMode('21_CabMech', 'bb21_na1_Cabbagemechanic'),
            VoiceMode('21_TragicLoss', 'bb21_na2_Tragicloss'),
            VoiceMode('21_Cmdr_AF', 'bb21_na3_Cmdraf'),
            VoiceMode('21_MasterTortoise', 'bb21_asia1_Mastertortoise'),
            VoiceMode('21_SummerTiger', 'bb21_asia2_Summertiger'),
            VoiceMode('21_Maharlika', 'bb21_asia3_Maharlika'),
            VoiceMode('gup_jp_commander', 'gup_jp_commander'),
            VoiceMode('gup_jp_crew', 'gup_jp_crew'),
            VoiceMode('duke', 'duke'),
            VoiceMode('cobra', 'cobra'),
            VoiceMode('gagarin21', 'gagarin21'),
            ...
            VoiceMode('hannelore23_en', 'hannelore23_en'),
            VoiceMode('hannelore23_ru', 'hannelore23_ru'),
            VoiceMode('hannelore23_cn', 'hannelore23_cn'),
            VoiceMode('jana23_en', 'jana23_en'),
            VoiceMode('jana23_ru', 'jana23_ru'),
            VoiceMode('jana23_cn', 'jana23_cn'),
            VoiceMode('skill4ltu_23', 'skill4ltu_23'),
            VoiceMode('talktomeGoose', 'talktomeGoose'),
            ...
            VoiceMode('tankman_bp_12_m_10', 'tankman_bp_12_m_10'),
            VoiceMode('tankmen_bp1002_1', 'tankmen_bp1002_1'),
            VoiceMode('tankmen_bp1002_3', 'tankmen_bp1002_3'),
            VoiceMode('tankmen_bp1004_1', 'tankmen_bp1004_1'),
            VoiceMode('tankmen_bp1004_2', 'tankmen_bp1004_2'),
            VoiceMode('tankmen_bp1004_3', 'tankmen_bp1004_3'),
            VoiceMode('tankmen_bp1004_4', 'tankmen_bp1004_4'),
            VoiceMode('tankmen_bp1004_5', 'tankmen_bp1004_5'),
            VoiceMode('celebrity2024_en', 'celebrity2024_en'),
            VoiceMode('celebrity2025_en', 'celebrity2025_en'),
            ...
            VoiceMode('tankmen_bp13_9', 'tankmen_bp13_9'),
            VoiceMode('tankmen_bp14_5', 'tankmen_bp14_5'),
            VoiceMode('tankmen_bp14_6', 'tankmen_bp14_6'),
            VoiceMode('tankmen_bp15_5', 'tankmen_bp15_5'),
            VoiceMode('tankmen_bp15_6', 'tankmen_bp15_6'),
            VoiceMode('tankmen_bp15_7', 'tankmen_bp15_7'),
            VoiceMode('tankmen_bp15_8', 'tankmen_bp15_8'),
            VoiceMode('tankmen_bp15_9', 'tankmen_bp15_9'),
            VoiceMode('tankmen_bp16_5', 'tankmen_bp16_5'),
            VoiceMode('tankmen_bp16_6', 'tankmen_bp16_6'),
            VoiceMode('tankmen_bp16_7', 'tankmen_bp16_7'),
            VoiceMode('tankmen_bp16_8', 'tankmen_bp16_8'),
            VoiceMode('tankmen_bp16_9', 'tankmen_bp16_9'),
            VoiceMode('tankmen_bp17_5', 'tankmen_bp17_5'),
            VoiceMode('tankmen_bp17_8', 'tankmen_bp17_8'),
            VoiceMode('tankmen_mtlb1_1', 'tankmen_mtlb1_1'),
            VoiceMode('MartyVole', 'MartyVole'),
            VoiceMode('cygan', 'cygan'),
            VoiceMode('kirk', 'kirk'),
            VoiceMode('spock', 'spock'),
            VoiceMode('uhura', 'uhura'),
            VoiceMode('gup_erika', 'gup_erika'),
            VoiceMode('gup_mika', 'gup_mika'),
            VoiceMode('gup_crew_24', 'gup_crew_24'),
            VoiceMode('gup_crew_25', 'gup_crew_25'),
            VoiceMode('gup_alice', 'gup_alice'),
            VoiceMode('gup_darjeeling', 'gup_darjeeling'),
            VoiceMode('ermelinda24_en', 'ermelinda24_en'),
            VoiceMode('ermelinda24_cn', 'ermelinda24_cn'),
            VoiceMode('krieger24_en', 'krieger24_en'),
            VoiceMode('krieger24_cn', 'krieger24_cn'),
            VoiceMode('mouzAkrobat24', 'mouzAkrobat24'),
            VoiceMode('quickyBaby24', 'quickyBaby24'),
            VoiceMode('dakillzor24', 'dakillzor24'),
            VoiceMode('skill4ltu24', 'skill4ltu24'),
            VoiceMode('bMeng24', 'bMeng24'),
            VoiceMode('saoNian24', 'saoNian24'),
            VoiceMode('yiTuanTuan24', 'yiTuanTuan24'),
            VoiceMode('zhongPengFei24', 'zhongPengFei24'),
        ]
        self.music_modes = [
